...
use protocol::{GetUniqueIdEndpoint, SetDirectionEndpoint, SetStepperEndpoint};
use pyo3::prelude::*;
...
/// This /// This class communicates with Bluepill Rust firmware. You can pass a serial number to the
...
impl StepperClient {
    ...
    async fn set_direction(&self, direction: u8) -> Result<(), BoardError<Infallible>> {
        self.client
            .send_resp::<SetDirectionEndpoint>(&direction)
            .await?;
        Ok(())
    }
}
